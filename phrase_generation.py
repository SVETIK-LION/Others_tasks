...
class Heroes:
    ...
    def generate_phrase(self, name_1: str, name_2: str, damage: int, weapon: str, type_attack: str):
        """
        :param name_1: Имя первого персонажа
        :param name_2: Имя второго персонажа
        :param damage: Урон
        :param weapon: Оружие
        :param type_attack: Тип атаки
        :return: Возвращает f-строку фразу
        """
...
if __name__ == '__main__':
    heroes = Heroes()
    print(heroes.generate_phrase('Единорожка', 'Муся-Пуся', 14, 'Рог', 'ATACK'))
    print(heroes.generate_phrase('Ололошка', 'Кентавриха', 6, 'СвинцовоеКопыто', 'FAIL'))
    print(heroes.generate_phrase('ЧеткийГепард', 'БогСолнца', 0, 'ЛучиДобра', 'BLOCK'))
    print(heroes.generate_phrase('Кошка', 'Собака', 8, 'Когти', 'no_name'))
